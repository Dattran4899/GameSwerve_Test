...
#nullable enable
    ...
    {
        public static void ForEachWithoutExclusions<TEnum>(this IEnumerable<TEnum> enums, Action<TEnum> executionPerItem)
            where TEnum : Enum
        {
            ...
            {
                if (excludeAttribute.IsExcluded(enumValue))
                {
                    continue;
                }
        ...
        public static IEnumerable<TEnum> WithoutExclusions<TEnum, TResult>(this IEnumerable<TEnum> enums, Func<TEnum, TResult> selector)
            where TEnum : Enum
        {
            var excludeAttribute = (EnumEnumerableExcludeAttribute)(Attribute.GetCustomAttribute(typeof(TEnum),
                typeof(EnumEnumerableExcludeAttribute)) ?? new EnumEnumerableExcludeAttribute());
